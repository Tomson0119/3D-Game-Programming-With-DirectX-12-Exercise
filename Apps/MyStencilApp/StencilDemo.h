...
class MyStencilDemo : public MyD3DApp
{
public:

	MyStencilDemo();
	MyStencilDemo(const MyStencilDemo& rhs) = delete;
	MyStencilDemo& operator=(const MyStencilDemo& rhs) = delete;
	~MyStencilDemo();
...
private:
	...
	void UpdateReflectedPassCB(const MyGameTimer& gt);
