...
void MyWavesCsApp::Update(const MyGameTimer& gt)
{
	OnKeyboardInput(gt);
	UpdateCamera(gt);
...
void MyWavesCsApp::Draw(const MyGameTimer& gt)
{
...
void MyWavesCsApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void MyWavesCsApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void MyWavesCsApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void MyWavesCsApp::OnKeyboardInput(const MyGameTimer& gt)
{
...
void MyWavesCsApp::UpdateCamera(const MyGameTimer& gt)
{
...
void MyWavesCsApp::AnimateMaterials(const MyGameTimer& gt)
{
...
void MyWavesCsApp::UpdateObjectCBs(const MyGameTimer& gt)
{
...
void MyWavesCsApp::UpdateMaterialCBs(const MyGameTimer& gt)
{
...
void MyWavesCsApp::UpdateMainPassCB(const MyGameTimer& gt)
{
...
void MyWavesCsApp::UpdateWaves(const MyGameTimer& gt)
{
...
void MyWavesCsApp::LoadTextures()
{
...
void MyWavesCsApp::BuildRootSignature()
{
...
void MyWavesCsApp::BuildDescriptorHeaps()
{
	// Resources container.
...
void MyWavesCsApp::BuildShadersAndInputLayout()
{
...
void MyWavesCsApp::BuildLandGeometry()
{
...
void MyWavesCsApp::BuildWavesGeometry()
{
...
void MyWavesCsApp::BuildBoxGeometry()
{
	MyGeometryGenerator geoGen;
...
void MyWavesCsApp::BuildTreeSpritesGeometry()
{
...
void MyWavesCsApp::BuildPSOs()
{
	...
	opaquePsoDesc.BlendState = CD3DX12_BLEND_DESC(D3D12_DEFAULT); // Ex 11-9
...
void MyWavesCsApp::BuildFrameResources()
{
...
void MyWavesCsApp::BuildMaterials()
{
...
void MyWavesCsApp::BuildLandAndWavesRenderItems()
{
...
void MyWavesCsApp::DrawRenderItems(ID3D12GraphicsCommandList* cmdList, const std::vector<RenderItem*>& ritems)
{
...
std::array<const CD3DX12_STATIC_SAMPLER_DESC, 6> MyWavesCsApp::GetStaticSamplers()
{
...
float MyWavesCsApp::GetHillsHeight(float x, float z) const
{
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 MyWavesCsApp::GetHillsNormal(float x, float z) const
{
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
